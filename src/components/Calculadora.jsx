    ...
    return (
        <div className="grid shadow-md w-[360px] text-2xl font-bold">
            ...
            <div className="bg-white grow h-[480px] grid grid-cols-4">
                <button
                    className={`${buttonClassName} ${buttonClassName} bg-[#FEFAE0]`}
                    onClick={handleClear}
                >
                    C
                </button>
                <button
                    className={`${buttonClassName} ${buttonClassName} bg-[#FEFAE0] text-[#D4A373]`} 
                    onClick={() => handleClick("+")}
                >
                    +
                </button>
                ...
                <button
                    className={`${buttonClassName} ${buttonClassName} text-sm`}
